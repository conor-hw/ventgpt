...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Safe, empathetic AI support for your mental wellbeing"}],"link":[],"style":[],"script":[],"noscript":[],"title":"VentGPT - Your AI Mental Health Companion"};
