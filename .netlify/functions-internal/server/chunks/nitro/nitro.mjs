...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "35a15b06-9d0a-4acc-a89b-7b16eba52555",
  ...
  "geminiApiKey": "AIzaSyBILjwGdc24daa1RKrVBfVh3izieF3zr1E"
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_fkjmIa = () => import('../routes/api/chat.post.mjs');
const _lazy_pCJkh0 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/chat', handler: _lazy_fkjmIa, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_pCJkh0, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_pCJkh0, lazy: true, middleware: false, method: undefined }
];
